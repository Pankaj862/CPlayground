import type { StatsData } from "@/data/mockDashboardData";
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 animate-fade-in">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
        ...
        <div className="w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
          <div
            ...
            style={{ width: `${stats.ratingProgress}%` }}
          />
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
        ...
        <div className="flex items-center gap-1 mt-2">
          ...
          <span className="text-xs text-gray-400">{stats.globalPercentile} Globally</span>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
        ...
        <div className="flex items-center gap-1.5 mt-2">
          ...
          <span className="text-xs text-gray-400">Next badge at {stats.nextBadgeAt}</span>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
        ...
        <div className="flex items-baseline gap-1.5 mb-2">
          ...
          <span className="text-base font-semibold text-gray-400">/ {(stats.totalProblems / 1000).toFixed(1)}k</span>
        </div>
        <div className="flex items-center gap-1 mt-2">
          <svg className="w-3.5 h-3.5 text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
          </svg>
          <span className="text-xs text-gray-400">+{stats.solvedThisWeek} this week</span>
        </div>
      </div>
    </div>
  );
